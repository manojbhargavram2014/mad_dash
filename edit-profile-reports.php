									...
									<form>
										<div class="form-row">
											<div class="form-group col-md-6">
											  <label for="Username">Reporter Id</label>
											  <input type="text" class="form-control" id="username" readonly>
											</div>
											<div class="form-group col-md-6">
											  <label for="bio">Owner Id</label>
											  <input type="text" class="form-control" id="inputPassword4"  readonly>
											</div>
										</div>
										<div class="form-group">
											<label for="tagline">Report Reason</label>
											<input type="text" class="form-control" id="tagline" readonly>
										</div>
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="status">Status Of Report</label>
